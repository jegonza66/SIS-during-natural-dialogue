...
def Run(stim='Envelope', Band='Theta', tmin=-0.6, tmax=-0.003, situacion='Escucha',
        Stims_preprocess='Normalize', EEG_preprocess='Standarize', alpha=100,
        Statistical_test=False, Simulate_random_data=False, Display_Ind_Figures=False,
        Display_Total_Figures=True, Save_Ind_Figures=False, Save_Total_Figures=False,
        ...
        for sujeto, eeg, dstims in zip((1, 2), (eeg_sujeto_1, eeg_sujeto_2),
            ...
            for fold, (train_val_index, test_index) in enumerate(kf_test.split(eeg)):
                ...
                if Simulate_random_data:
                    ...
                    toy_iterations = 10
                    psd_rand_correlation = Simulation.simular_iteraciones_Ridge_plot(info, sr, situacion, alpha,
                                                                                     toy_iterations, sesion, sujeto,
                                                                                     fold,
                                                                                     dstims_train_val, eeg_train_val,
                                                                                     dstims_test, eeg_test)
    ...
    # PSD Boxplot
    Plot.PSD_boxplot(psd_pred_correlations, psd_rand_correlations, Display_Total_Figures, Save_Total_Figures,
                     Run_graficos_path)
