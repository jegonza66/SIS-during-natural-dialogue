...
def Estimulos(stim, Sujeto_1, Sujeto_2):
    ...
    envelope_para_sujeto_1, pitch_para_sujeto_1, pitch_der_para_sujeto_1 = Sujeto_2['Envelope'], Sujeto_2['Pitch'], Sujeto_2['Pitch_der']
    envelope_para_sujeto_2, pitch_para_sujeto_2, pitch_der_para_sujeto_2 = Sujeto_1['Envelope'], Sujeto_1['Pitch'], Sujeto_1['Pitch_der']
    info = Sujeto_1['info']
